...
#define STRING_CONFIG_H_AUTHOR "Anton Sithole - 3verteD" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender 3 V2 ABL & DD"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 415 }  // Ender3v2 Configs
